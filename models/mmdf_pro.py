...
class ImgBasicBlock(nn.Module):
    def __init__(self, in_channels, out_channels, stride=1):
        ...
        # self.conv2 = conv3x3(out_channels, out_channels, stride=stride * 2)
        # self.conv2 = conv3x3(2*out_channels, out_channels, stride=stride)
...
class FusionConv(nn.Module):
    ...
    def forward(self, pts_features, img_features):
        ...
        # weight_d128 = torch.tanh(add_w)
        # weight_map = torch.sigmoid(self.fc3(weight_d128))
        ...
        # fusion_features = self.pool(fusion_features)
...
class FusionModel(nn.Module):
    ...
    def forward(self, p, image=None, xy=None):
        ...
        for i in range(0, 4):
            ...
            # print(image_gather_feature.shape)
        ...
        # print(image_feature.shape)
        # global_feature = torch.cat((global_feature, image_feature), dim=1)
        # print(global_feature.shape)

        return global_feature
        # return global_feature, img[4], l_pc_feature[3], fusion_feature
